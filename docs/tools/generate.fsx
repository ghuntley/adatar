...
let referenceBinaries = [ "Adatar.dll" ]
// Web site location for the generated documentation
let website = "/Adatar"

let githubLink = "http://github.com/ghuntley/Adatar"

// Specify more information about your project
let info =
  [ "project-name", "Adatar"
    "project-author", "Geoffrey Huntley"
    "project-summary", "Adatar is a Active Directory microservice for employee photos, with optional fallback to Gravatar.com"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Adatar" ]
